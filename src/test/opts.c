...
Opts opts[] = {
    {"minitrc", 0, 2, "mpxwv", "a: configuration file"},
    {"cmd_spec", 0, 3, ".pxwv", "c: command executable"},
    {"mapp_desc", 0, 0, "mpxwv", "d: description file"},
    {"f_erase_remainder", 2, 5, "..xw.", "e: erase remainder of line on enter"},
    {"geometry", 0, 3, "mpxwv", "g: geometry (lllcccLLLCCC)"},
    {"in_spec", 0, 0, ".p...", "i: input spec"},
    {"mapp_home", 0, 1, "mpxwv", "m: home directory"},
    {"selections", 1, 4, ".p...", "n: number of selections"},
    {"out_spec", 0, 0, ".p.w.", "o: output spec"},
    ...
    {"mapp_user", 0, 1, "mpxwv", "u: user directory"},
    {"f_ignore_case", 2, 5, "....v", "x: ignore case in search"},
    {"f_at_end_clear", 2, 5, "mpxwv", "z  clear screen at end of program"},
    {"answer_spec", 0, 0, "..xw.", "A: answer spec"},
    {"bg_color", 1, 4, "mpxwv", "B: background_color"},
    {"cols", 1, 4, "mpxwv", "C: height in columns"},
    {"fg_color", 1, 4, "mpxwv", "F: foreground_color"},
    {"help_spec", 0, 0, "mpxwv", "H: help spec"},
    {"lines", 1, 4, "mpxwv", "L: width in lines"},
    {"bo_color", 1, 4, "mpxwv", "O: border_color"},
    {"prompt", 0, 3, "....v", "P: prompt (S-Short, L-Long, N-None)[string]"},
    {"start_cmd", 0, 3, "....v", "S  command to execute at start of program"},
    {"title", 0, 3, "mpxwv", "T: title"},
    {"begx", 1, 4, "mpxwv", "X: begin on column"},
    {"begy", 1, 4, "mpxwv", "Y: begin on line"},
    {"f_stop_on_error", 2, 5, "mpxwv", "Z  stop on error"},
    {"mapp_spec", 0, 2, "mpxwv", "   description file spec"},
    {"mapp_data", 0, 1, "mpxwv", "   data directory"},
    {"mapp_help", 0, 1, "mpxwv", "   help directory"},
    {"mapp_msrc", 0, 1, "mpxwv", "   source directory"},
    {"", 0, 0, "", ""}}; // End marker
