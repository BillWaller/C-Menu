...
Opts opts[] = {
    ...
    {"answer_spec", 0, 2, "..f.", "   answer file spec"},
    {"mapp_data", 0, 1, "mpfv", "   data directory"},
    {"mapp_spec", 0, 2, "mpfv", "   description file spec"},
    {"mapp_help", 0, 1, "mpfv", "   help directory"},
    {"help_spec", 0, 2, "mpfv", "   help file spec"},
    {"in_spec", 0, 2, ".p..", "   input file spec"},
    {"out_spec", 0, 2, ".p..", "   output file spec"},
