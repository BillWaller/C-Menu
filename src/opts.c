...
Opts opts[] = {
    ...
    {"f_ln", 2, 5, "...v", "N", "line numbers in view"},
    ...
    {"f_strip_ansi", 2, 5, "...v", "j", "always strip ansi when writing"},
    ...
    {"bg_clr_x", 1, 4, "mfpv", "B:", "background_color"},
    {"lines", 1, 4, "mfpv", "C:", "width in columns"},
    {"f_dump_config", 0, 1, "mfpv", "D", "f_dump_config"},
    {"fg_clr_x", 1, 4, "mfpv", "F:", "foreground color"},
    {"help_spec", 0, 0, "mfpv", "H:", "help spec"},
    {"cols", 1, 4, "mfpv", "L:", "height in lines"},
    {"f_mutiple_cmd_args", 2, 5, "..p.", "M", "multiple command arguments"},
    {"bo_clr_x", 1, 4, "mfpv", "O:", "border color"},
    {"ln_clr_x", 1, 4, "   v", "O:", "line number color"},
    {"ln__bg_clr_x", 1, 4, "mfpv", "O:", "line number background"},
    {"prompt-type", 0, 3, "...v",
    ...
    {"f_write_config", 0, 1, "mfpv", "W", "f_write_config"},
    ...
    {"editor", 0, 1, "mfpv", "", "default editor"},
