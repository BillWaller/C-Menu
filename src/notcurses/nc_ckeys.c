...
int main(void) {
    ...
    NCPlane *plane1 = plane_new(nc, 4, 40, 4, 10, "plane1", "┤ Plane 1 ├", "#00d7ff", "#1c1c1c");
    ncplane_putstr_yx(plane1, 1, 1, "Notcurses Plane 1");
    notcurses_render(nc);

    NCPlane *plane2 = plane_new(nc, 4, 40, 10, 10, "plane2", "┤ Plane 2 ├", "#c0c0c0", "#000714");
    ncplane_putstr_yx(plane2, 1, 1, "Notcurses Plane 2");
    notcurses_render(nc);
