...
void mapp_initialization(Init *init, int argc, char **argv) {
  ...
  strnz__cpy(sio->bg_clr_x, "#000007", COLOR_LEN - 1); /**< background color */
  strnz__cpy(sio->fg_clr_x, "#c0c0c0", COLOR_LEN - 1); /**< foreground color */
  strnz__cpy(sio->bo_clr_x, "#f00000", COLOR_LEN - 1); /**< bold color */
  strnz__cpy(sio->ln_clr_x, "#0070ff", COLOR_LEN - 1); /**< line number olor */
