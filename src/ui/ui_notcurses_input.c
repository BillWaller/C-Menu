...
static UiKey translate_nckey(uint32_t id, const ncinput *ni) {
    ...
    switch (id) {
    case NCKEY_RESIZE:    return UI_KEY_RESIZE;
    case NCKEY_ENTER:     return UI_KEY_ENTER;
    case NCKEY_ESC:       return UI_KEY_ESCAPE;
    case NCKEY_BACKSPACE: return UI_KEY_BACKSPACE;
    case NCKEY_TAB:       return UI_KEY_TAB;
    case NCKEY_UP:        return UI_KEY_UP;
    case NCKEY_DOWN:      return UI_KEY_DOWN;
    case NCKEY_LEFT:      return UI_KEY_LEFT;
    case NCKEY_RIGHT:     return UI_KEY_RIGHT;
    case NCKEY_HOME:      return UI_KEY_HOME;
    case NCKEY_END:       return UI_KEY_END;
    case NCKEY_PGUP:      return UI_KEY_PGUP;
    case NCKEY_PGDOWN:    return UI_KEY_PGDN;
    case NCKEY_INS:       return UI_KEY_INSERT;
    case NCKEY_DEL:       return UI_KEY_DELETE;
    case NCKEY_F01:       return UI_KEY_F1;
    case NCKEY_F02:       return UI_KEY_F2;
    case NCKEY_F03:       return UI_KEY_F3;
    case NCKEY_F04:       return UI_KEY_F4;
    case NCKEY_F05:       return UI_KEY_F5;
    case NCKEY_F06:       return UI_KEY_F6;
    case NCKEY_F07:       return UI_KEY_F7;
    case NCKEY_F08:       return UI_KEY_F8;
    case NCKEY_F09:       return UI_KEY_F9;
    case NCKEY_F10:       return UI_KEY_F10;
    case NCKEY_F11:       return UI_KEY_F11;
    case NCKEY_F12:       return UI_KEY_F12;
    default:
