...
static UiKey translate_key(int ch) {
    ...
    case '\n':
    case '\r': return UI_KEY_ENTER;
    case 27: return UI_KEY_ESCAPE;
    case '\t': return UI_KEY_TAB;
    case KEY_BTAB: return UI_KEY_BTAB;
    ...
    case KEY_PPAGE: return UI_KEY_PGUP;
    case KEY_NPAGE: return UI_KEY_PGDN;
    case KEY_IC: return UI_KEY_INSERT;
    case KEY_DC: return UI_KEY_DELETE;
    case KEY_BACKSPACE: return UI_KEY_BACKSPACE;
    case KEY_RESIZE: return UI_KEY_RESIZE;
    case KEY_MOUSE: return UI_KEY_MOUSE;
    case KEY_F(1): return UI_KEY_F1;
    case KEY_F(2): return UI_KEY_F2;
    case KEY_F(3): return UI_KEY_F3;
    case KEY_F(4): return UI_KEY_F4;
    case KEY_F(5): return UI_KEY_F5;
    case KEY_F(6): return UI_KEY_F6;
    case KEY_F(7): return UI_KEY_F7;
    case KEY_F(8): return UI_KEY_F8;
    case KEY_F(9): return UI_KEY_F9;
    case KEY_F(10): return UI_KEY_F10;
    case KEY_F(11): return UI_KEY_F11;
    case KEY_F(12): return UI_KEY_F12;
    default:
        if (ch >= 32 && ch <= 126) return UI_KEY_CHAR;
        return UI_KEY_NONE;
    }
}
