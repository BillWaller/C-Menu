...
extern Form *new_form(Init *, int, char **, uint, uint);
extern Pick *new_pick(Init *, int, char **, uint, uint);
extern Menu *new_menu(Init *, int, char **, uint, uint);
extern int popup_menu(Init *, int, char **, uint, uint);
extern int popup_form(Init *, int, char **, uint, uint);
extern int popup_pick(Init *, int, char **, uint, uint);
extern int popup_view(Init *, int, char **, uint, uint, uint, uint);
...
extern int init_form(Init *, int, char **, uint, uint);
extern int init_pick(Init *, int, char **, uint, uint);
