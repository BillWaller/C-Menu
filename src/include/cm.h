...
extern int a_toi(char *, bool *) __attribute__((nonnull(1)));
extern bool chrep(char *, char, char);
extern char *rep_substring(const char *, const char *, const char *) __attribute__((nonnull(1, 2, 3)));
extern size_t strip_ansi(char *, char *);
extern bool strip_quotes(char *) __attribute__((nonnull(1)));
extern bool stripz_quotes(char *) __attribute__((nonnull(1)));
extern int str_to_args(char **, char *, uint) __attribute__((nonnull(1, 2)));
...
extern bool str_subc(char *, char *, char, char *, uint) __attribute__((nonnull(1, 2, 4)));
extern size_t strnz(char *, size_t) __attribute__((nonnull(1)));
extern size_t strnlf(char *, size_t) __attribute__((nonnull(1)));
extern char *strnz_dup(char *, size_t) __attribute__((nonnull(1)));
extern size_t ssnprintf(char *, size_t, const char *, ...) __attribute__((nonnull(1)));
extern size_t strnz__cpy(char *, const char *, size_t) __attribute__((nonnull(1, 2)));
extern size_t strnz__cat(char *, const char *, size_t) __attribute__((nonnull(1, 2)));
