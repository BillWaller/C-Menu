/** @file form.h
 *  @brief Form data structures, enums, types, end getter declarations
 *  @author Bill Waller
 *  Copyright (c) 2025
 *  MIT License
...
enum {
    ...
    P_REFUSE, /**< refuse the form, e.g. after accepting a field and the field
                 value is invalid */
    P_CALC,   /**< getter the form, e.g. after accepting a field and
...
typedef struct {
    ...
    char receiver_cmd
        [MAXLEN];     /**< the receiver command, which can be executed in the
                         ...
                         getter programs or commands during form processing. */
    ...
    bool f_receiver_cmd; /**< flag - if set, indicates that the receiver command
                            ...
                            output generated by getter programs or commands as
