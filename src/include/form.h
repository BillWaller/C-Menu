/** @file form.h
 *  @brief Form data structures, enums, types, end process declarations
 *  @author Bill Waller
 *  Copyright (c) 2025
 *  MIT License
...
typedef struct {
    ...
    char receiver_cmd
        [MAXLEN];     /**< the receiver command, which can be executed in the
                         ...
                         process programs or commands during form processing. */
    ...
    bool f_query;             /**< flag - if set, the action key label will be "query"
                                 instead of "process" or "calculate". */
    ...
    bool f_receiver_cmd;      /**< flag - if set, indicates that the receiver command
                                 ...
                                 output generated by process programs or commands as
    ...
    wchar_t brktl[5];         /**< the ncurses cchar_t representation of the left bracket
                              character, used for displaying the left bracket in the
                              form window during form processing. */
    wchar_t brktr[5];         /**< the ncurses cchar_t representation of the right bracket
                              character, used for displaying the right bracket in the
                              form window during form processing. */
    char fill_char[4];        /**< the character used to fill the field input areas in
